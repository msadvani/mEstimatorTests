function [ F2, I ] = computeConstraint2(q0,c, fNoise, g,kappa,form, lambda,N0,L0,pTol)
...
F2 = c./(1+c)-kappa*sum(xi(q0,c).*proxSigmaPrime(convMeas,1/(2*cHat(q0,c)),form,lambda))*dConvMeas;
...
% end
% 
% %returns F2 only when I is close enough to 1.
